...
# Download
python3 bertPrep.py --action download --dataset bookscorpus
python3 bertPrep.py --action download --dataset wikicorpus_en
...
python3 bertPrep.py --action text_formatting --dataset bookscorpus
python3 bertPrep.py --action text_formatting --dataset wikicorpus_en


# Shard the text files (group wiki+books then shard)
python3 bertPrep.py --action sharding --dataset books_wiki_en_corpus


# Create HDF5 files Phase 1
python3 bertPrep.py --action create_hdf5_files --dataset books_wiki_en_corpus --max_seq_length 128 \
...
python3 bertPrep.py --action create_hdf5_files --dataset books_wiki_en_corpus --max_seq_length 512 \
